...
public class CurrentStatus extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String booked = db.getMyAvailability(seats, tid, mid, date, showtime);
            ...
            for (int i = 1; i <= rows; i++) {
                ...
                for (int j = 1; j <= cols; j++) {
                    ...
                    boolean flag = true;
                    boolean flag1 = true;
                    for (int l = 0; l < noOfSeats; l++) {
                        if (seat.equals(seatsArr[l])) {
                            out.print("<div id=" + seat + " class='selected'></div>");
                            flag = false;
                            flag1 = false;
                        }
                    }
