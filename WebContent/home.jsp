...
<%@page import="edu.cis.ksu.acad.model.Theatre"%>
<%@page import="edu.cis.ksu.acad.logic.TheatreDAO"%>
                            ...
                            <td>                    
                                <select name="theatre" id="theatre">
                                    <option value="0">--select--</option>
                                      <%
                                    	TheatreDAO td = new TheatreDAO();
                                    	ArrayList<Theatre> theartres = td.getAllTheatres();
                                        if(theartres!=null){   
              							for (Theatre theartre : theartres) { 
             							 out.print("<option value='" + theartre.getTheatre_id() + "'>");
                                                  out.print(theartre.getTheatre_name());
                                                  out.print("</option>");
            	   							 }
                                        }
                                    %>                        
